...
import { HeaderComponent, HeaderMobileComponent, FormContactComponent, ChatComponent,
		FooterComponent, NavigationComponent, SocialAppComponent, HeadlineComponent
		} from './general';
...
@NgModule({
    declarations: [PublicComponent, HomeComponent, SlideComponent, ServiceComponent, StaffComponent, EquipmentComponent, PartnerComponent,
    				...
    				HeaderComponent, HeaderMobileComponent, FormContactComponent, ChatComponent, SocialAppComponent, FooterComponent, HeadlineComponent],
