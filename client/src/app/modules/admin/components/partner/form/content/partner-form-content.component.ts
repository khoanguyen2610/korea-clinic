...
@Component({
	selector: 'app-partner-form-content',
	templateUrl: './partner-form-content.component.html',
})

export class PartnerFormContentComponent implements OnInit {
	private subscription: Subscription;
	@Input() is_validated: boolean;
	@Input() language_code: string;
	@Input() Item = new Partner();
