...
export class SlideListComponent implements OnInit {
	...
	constructor(
		...
		this.url_list_data = this._SlideService._list_data_URL + '?image_resize_width=300&' + url_params.toString();
	}
	...
	onRoutingUpdate(id: number, item_key: string){
		this._Router.navigate(['/admin/slide/form/update/' + id], {queryParams: { item_key: item_key }} );
	}
	...
	onSearch(){
		 ...
		 *====================================*/
		this._Router.navigate(['/admin/slide/list'], { queryParams: this.filter });
		/*====================================
		 * Reload Datatable
		 *====================================*/
		let _list_data_URL = this._SlideService._list_data_URL + '?image_resize_width=300&' + $.param(this.filter);
