...
import { AuthService, FaqService, ServiceService } from '../../../../../services';
...
@Component({
	...
	providers: [ FaqService, ServiceService ]
})
...
export class FaqListComponent implements OnInit {
	...
	constructor(
		...
		this.url_list_data = this._FaqService._list_data_URL + '?' + url_params.toString();
	}
	...
	onSearch(){
		 ...
		 *====================================*/
		this._Router.navigate(['/admin/faq/list'], { queryParams: this.filter });
		/*====================================
		 * Reload Datatable
		 *====================================*/
		let _list_data_URL = this._FaqService._list_data_URL + '?' + $.param(this.filter);
