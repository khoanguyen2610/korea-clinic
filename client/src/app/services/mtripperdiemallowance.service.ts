/*
* @Author: th_le
* @Date:   2016-12-06 14:21:20
* @Last Modified by:   th_le
* @Last Modified time: 2016-12-06 14:22:07
*/
...
@Injectable()
export class MTripPerdiemAllowanceService {

    private serviceUrl: string = 'master_MTripPerdiemAllowance/';
