...
@Injectable()
export class MImportUserDepartmentService {

    private serviceUrl: string = 'master_mimportuserdepartment/';
    ...
    public importUserDepartment(params) {
        let headers = new Headers();
        this.createAuthorizationHeader(headers);
        return this._HttpClient.post(this._Configuration.apiUrl + this.serviceUrl + 'import_user_department', params, {
            headers: headers,
            withCredentials: true
        })
        .map(res => res.json())
    ...
    public delete(id: number) {
        let headers = new Headers();
        this.createAuthorizationHeader(headers);
        return this._HttpClient.delete(this._Configuration.apiUrl + this.serviceUrl + 'index/' + id, {
            headers: headers,
            withCredentials: true
        })
        .map(res => res.json())
