...
@Component({
	...
	templateUrl: './payment-purchase-list.component.html',
})

export class PaymentPurchaseListComponent implements AfterViewInit{
	...
	onOpenFormPurchase(i = null, action: string){
		let obj: any;
		if(i==null){
			obj = new TPurchaseReceptionSpec();
		}else{
			this.update_index = i;
