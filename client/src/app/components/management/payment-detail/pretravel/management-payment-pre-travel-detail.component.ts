...
@Component({
	selector: 'management-payment-pre-travel-detail',
	templateUrl: './management-payment-pre-travel-detail.component.html',
	providers: [ MExpenseItemService, MTripAreaService ]
})

export class ManagementPaymentPreTravelDetailComponent implements OnInit{
	@Input() item: any;
