...
class Controller_Master_MTripArea extends \Controller_API {
	public function before() {
        parent::before();
        $this->main_table = 'm_trip_area';
    ...
    public function post_index($pk = null){
        ...
        if($validation->run()){
            ...
            //======================== Default Data =================
            $Item = empty($pk)?\Model_MTripArea::forge():\Model_MTripArea::find($pk);
    ...
    public function delete_index($pk = null){
        if(!empty($pk)){
            $result = \Model_MTripArea::softDelete($pk, array('item_status' => 'delete'));
            $status = 'success';
    ...
    public function get_list_data(){
        $result     = \Model_MTripArea::listData($this->_arrParam['post_params'], array('task'=>'list-dbtable'));
        $items      = $result['data'];
