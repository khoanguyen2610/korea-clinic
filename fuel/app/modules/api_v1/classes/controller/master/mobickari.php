...
class Controller_Master_MObicKari extends \Controller_API {
	public function before() {
        parent::before();
        $this->main_table = 'm_obic_kari';
    ...
    public function post_index($pk = null){
        ...
        if($validation->run()){
            ...
            //======================== Default Data =================
            $Item = empty($pk)?\Model_MObicKari::forge():\Model_MObicKari::find($pk);
    ...
    public function delete_index($pk = null){
        if(!empty($pk)){
            $result = \Model_MObicKari::softDelete($pk, array('item_status' => 'delete'));
            $status = 'success';
    ...
    public function get_list_data(){
        $result     = \Model_MObicKari::listData($this->_arrParam['post_params'], array('task'=>'list-dbtable'));
        $items      = $result['data'];
