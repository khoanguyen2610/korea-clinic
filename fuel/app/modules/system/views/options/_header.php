<?php
    $linkCreate     = \Uri::create('system/options/create');
    $linkBack       = \Uri::create('system/options');

    $xhtmlButton = '';
    switch ($action) {
        case 'index':
            $xhtmlButton = '<a href="modal_form_horizontal" class="btn border-slate text-slate-800 btn-flat ajax-modal" data-toggle="modal" >
