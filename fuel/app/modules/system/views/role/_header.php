<?php
    $linkCreate     = \Uri::create('system/role/create');
    $linkBack       = \Uri::create('system/role');

    $xhtmlButton = '';
    switch ($action) {
        case 'index':
            $xhtmlButton = '<a href="#" id="btn_update_area" class="btn border-slate text-slate-800 btn-flat">
                                <i class="icon-spinner2 position-left"></i>' . __('Update Area', array(), 'Update Area') . '
                            </a>
