...
class Vision_Download {
	...
	*/
	...
	private $args = array(
						...
						'direct_view'			=> FALSE,
						'origin_file_name'		=> FALSE,
						'referrer_check'		=> FALSE,
						'referrer'				=> NULL,
					);
	private $allowed_extensions_direct_view = array(
					  	/* Documents */
					  	'txt'	=> 'text/plain',
						'pdf'	=> 'application/pdf',
					  	/* Images */
	...
	*/
	public function set_download() {
		...
		*/
		...
		if($args['direct_view'] && array_key_exists($download_hook['file_extension'], $this->allowed_extensions_direct_view)){

		}else{
			$file = !empty($args['origin_file_name'])?$args['origin_file_name']:$file;
