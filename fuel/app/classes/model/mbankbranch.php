...
/**
 * @Author: k_nguyen
 * @Date:   2016-11-14 11:46:10
 * @Last Modified by:   k_nguyen
 * @Last Modified time: 2016-12-01 15:21:36
 */
class Model_MBankBranch extends \Orm\Model {
	protected static $_table_name = 'm_bank_branch';
    ...
    public static function listData($arrParam = null, $options = null){
        if($options['task'] == 'list-dbtable'){
             ...
             *===========================================*/
            if(isset($arrParam['m_bank_id']) && $arrParam['m_bank_id'] != null){
                $query->and_where('SM.m_bank_id', $arrParam['m_bank_id']);
            }
            ...
            if(isset($arrParam['name_kana']) && $arrParam['name_kana'] != null){
                $query->and_where('SM.name_kana', 'LIKE', '%' . $arrParam['name_kana'] . '%');
            }  
            if(isset($arrParam['name_e']) && $arrParam['name_e'] != null){
                $query->and_where('SM.name_e', 'LIKE', '%' . $arrParam['name_e'] . '%');
            }  
