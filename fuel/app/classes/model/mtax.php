 ...
 * @Last Modified time: 2016-11-30 16:29:06
 */
class Model_MTax extends \Orm\Model {
	protected static $_table_name = 'm_tax';
    ...
    public static function listData($arrParam = null, $options = null){
        if($options['task'] == 'list-dbtable'){
            $columns = [
                            ['db' => 'SM.value', 'dt' => 0],
                            ['db' => 'SM.enable_start_date', 'dt' => 1],
                            ['db' => 'SM.enable_end_date', 'dt' => 2],
                        ];
