...
(function(b) {
	var m, t, u, f, D, j, E, n, z, A, q = 0, e = {}, o = [], p = 0, d = {}, l = [], G = null, v = new Image, J = /\.(jpg|gif|png|bmp|jpeg)(.*)?$/i, W = /[^\.]\.(swf)\s*$/i, K, L = 1, y = 0, s = "", r, i, h = false, B = b
		...
		/*===================================================
		 * KhoaNguyen
		 * Add id="contain_content" into div
		 */
		m.wrapInner('<div id="contain_content" style="width:'
				+ a
				+ ";height:"
				+ c
				+ ";overflow: "
				/*=======================================================
				 * KhoaNguyen edit
				 * In case user don't use attribute overflow
				 * input  : scrolling : "none"
				 * output : overflow  : none
				 *========================================================*/
				+ (e.scrolling == "auto" ? "auto"
						: e.scrolling == "yes" ? "scroll"
						: e.scrolling == "no" ? "hidden" : "none")
