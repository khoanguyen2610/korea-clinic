...
$(function() {
    ...
    function containerHeight() {
        ...
        //minus 92px because of fixed header and navigation
        var availableHeight = $(window).height() - 92 - $('body > .navbar').outerHeight() - $('body > .navbar + .navbar').outerHeight() - $('body > .navbar + .navbar-collapse').outerHeight() - $('.page-header').outerHeight();
